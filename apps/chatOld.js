...
function buildShell(container, peerLabel = '') {
  container.innerHTML = `
  <div style="max-width:960px;margin:24px auto;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
    <!--aside style="display:none;border-right:1px solid #e5e7eb;min-height:60vh;">
