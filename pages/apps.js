import { Apps } from '../js/appsRegistry.js';
...
export async function run(containerId = 'content') {
   ...
   // const apps = getList('apps');
    ...
    Apps.getMap().forEach(args=>{
      ...
      if ( args.icon ) {
        svg.innerHTML = args.icon(40,40);
       
      }
      else {
        svg.innerHTML = `
            <svg fill="#000000" width="${width}px" height="${height}px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
